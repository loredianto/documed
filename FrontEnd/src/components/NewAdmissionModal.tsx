...
/**
 * Apertura di un nuovo ricovero programmato. Il ricovero esiste solo per un
 * paziente già registrato in anagrafe: prima si seleziona (o si registra) il
 * paziente, poi si compilano i dati del ricovero. Niente paziente registrato →
 * niente ricovero. L'operatore dell'accettazione sceglie la disciplina di
 * destinazione del ricovero (nessuna disciplina predefinita).
 */
  ...
  return (
    <form className="dm-new-adm" onSubmit={handleSubmit}>
      ...
      <div className="dm-add-fields">
        ...
        <label className="dm-add-field">
          <span>Disciplina di ricovero</span>
          <select
            className="form-select"
            required
            value={input.department}
            onChange={(e) => setInput((c) => ({ ...c, department: e.target.value }))}
          >
      ...
      <label className="dm-add-field mb-4">
        ...
        <textarea
          ...
          placeholder="Quesito diagnostico o note amministrative del ricovero"
        />
      </label>
      ...
      <div className="d-flex justify-content-end gap-2">
        ...
        <button type="submit" className="btn btn-primary" disabled={busy || !input.department}>
