  ...
  return (
    <section>
      <header className="page-header with-action">
        <div>
          <span className="eyebrow">Ricovero #{admission.id}</span>
      ...
      <div className="section-heading">
        <div><span className="eyebrow">Archivio</span><h2>Documenti del ricovero</h2></div>
      ...
      {documents.length === 0 ? (
        <EmptyState>Nessun documento caricato.</EmptyState>
      ) : (
